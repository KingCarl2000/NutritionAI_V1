...
from utils.main_utils.utils import load_numpy_array_data,evaluate_models
...
import dagshub
dagshub.init(repo_owner='KingCarl2000', repo_name='networksecurity1', mlflow=True)

#os.environ["MLFLOW_TRACKING_URI"]="https://dagshub.com/KingCarl2000/networksecurity1.mlflow"
#os.environ["MLFLOW_TRACKING_USERNAME"]="KingCarl2000"
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric, model_name=""):
        ...
        with mlflow.start_run():
            ...
            # --- BỔ SUNG LOG PARAM Ở ĐÂY ---
            mlflow.log_param("best_model_name", model_name)
            if hasattr(best_model, "get_params"):
                for param_key, param_val in best_model.get_params().items():
